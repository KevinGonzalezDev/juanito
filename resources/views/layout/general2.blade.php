        ...
        <div class = 'ContentHeader'>
            <table width ='100%'>
                <tr>
                    ...
                    <td width = '70%'>
                        <table width ='100%' class = 'MenuNavegacion'>
                            <tr>
                                <td><a href='{{route("Inicio")}}'>Home</a></td>
                                <td><a href='{{route("Emprendimiento")}}'>Emprendimiento</a></td>
                                <td><a href='{{route("GaleriaTecnologica")}}'>Galería Tecnológica</a></td>
                                <td>Descarga tu Certificado</td>
                                <td style="display:flex; justify-content:center;">
                                    <a href = 'https://eventmovil.com/entradas/events/index.php?id=237'>
                                        <span class = 'BtnIngreso' style = 'font-size:14px'>Iniciar sesión</span>
                                    </a>
                                </td>
                            </tr>
                        </table>
